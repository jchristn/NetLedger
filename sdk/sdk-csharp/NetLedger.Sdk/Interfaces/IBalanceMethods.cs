namespace NetLedger.Sdk.Interfaces
{
    ...
    public interface IBalanceMethods
    {
        ...
        Task<Balance> GetAsync(string accountId, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="NetLedgerConnectionException">Thrown when unable to connect to the server.</exception>
        /// <exception cref="NetLedgerApiException">Thrown when the server returns an error (404 if account not found).</exception>
        Task<Balance> GetAsOfAsync(string accountId, DateTime asOfUtc, CancellationToken cancellationToken = default);

        /// <summary>
        /// Get balances for all accounts.
        /// </summary>
        /// <param name="cancellationToken">Cancellation token.</param>
        /// <returns>Dictionary mapping account Ids to their balances.</returns>
        /// <exception cref="NetLedgerConnectionException">Thrown when unable to connect to the server.</exception>
        ...
        /// <exception cref="NetLedgerConnectionException">Thrown when unable to connect to the server.</exception>
        /// <exception cref="NetLedgerApiException">Thrown when the server returns an error (404 if account not found).</exception>
        Task<CommitResult> CommitAsync(string accountId, CancellationToken cancellationToken = default);

        /// <summary>
        /// Commit specific pending entries for an account.
        /// </summary>
        /// <param name="accountId">The Id of the account.</param>
        /// <param name="entryIds">The Ids of the entries to commit.</param>
        /// <param name="cancellationToken">Cancellation token.</param>
        /// <returns>The result of the commit operation.</returns>
        /// <exception cref="ArgumentNullException">Thrown when entryIds is null.</exception>
        /// <exception cref="NetLedgerConnectionException">Thrown when unable to connect to the server.</exception>
        /// <exception cref="NetLedgerApiException">Thrown when the server returns an error (404 if account not found).</exception>
        Task<CommitResult> CommitAsync(string accountId, List<string> entryIds, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="NetLedgerConnectionException">Thrown when unable to connect to the server.</exception>
        /// <exception cref="NetLedgerApiException">Thrown when the server returns an error (404 if account not found).</exception>
        Task<bool> VerifyAsync(string accountId, CancellationToken cancellationToken = default);
    }
}
