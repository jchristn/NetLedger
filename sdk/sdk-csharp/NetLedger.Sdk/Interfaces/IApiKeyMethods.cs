namespace NetLedger.Sdk.Interfaces
{
    ...
    public interface IApiKeyMethods
    {
        ...
        /// <returns>The created credential and one-time secret key.</returns>
        ...
        Task<CredentialCreateResponse> CreateAsync(string name, bool isAdmin = false, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="NetLedgerConnectionException">Thrown when unable to connect to the server.</exception>
        /// <exception cref="NetLedgerApiException">Thrown when the server returns an error (401 if not authorized).</exception>
        Task<CredentialCreateResponse> CreateAsync(ApiKeyInfo apiKey, CancellationToken cancellationToken = default);
        ...
        /// </summary>
        /// <param name="apiKeyId">The Id of the API key to revoke.</param>
        /// <param name="cancellationToken">Cancellation token.</param>
        ...
        Task RevokeAsync(string apiKeyId, CancellationToken cancellationToken = default);
    }
}
