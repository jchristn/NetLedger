...
echo ============================================
echo NetLedger Archive Server Docker Build Script
echo ============================================
echo.
...
if "%~1"=="" (
    ...
    echo.
    echo Usage: build-archive.bat ^<tag^>
    echo Example: build-archive.bat v4.0.0
    exit /b 1
)

set IMAGE_NAME=jchristn77/netledger-archive
set IMAGE_TAG=%~1
set DOCKERFILE_PATH=src/NetLedger.Archive.Server/Dockerfile
