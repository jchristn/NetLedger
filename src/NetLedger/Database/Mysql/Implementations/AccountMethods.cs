namespace NetLedger.Database.Mysql.Implementations
{
    ...
    /// <summary>
    /// MySQL implementation of account methods.
    /// </summary>
    internal class AccountMethods : IAccountMethods
    {
        ...
        internal AccountMethods(MysqlDatabaseDriver driver)
        {
        ...
        {
            string query = "SELECT * FROM `accounts` WHERE `guid` = '" + Sanitize(guid.ToString()) + "' LIMIT 1;";
