namespace NetLedger
{
    ...
    /// <summary>
    /// Object used to request account enumeration.
    /// </summary>
    public class AccountEnumerationQuery
    {
        ...
        /// <summary>
        /// Only include accounts created on or after this timestamp UTC.
        /// </summary>
        public DateTime? CreatedAfterUtc { get; set; } = null;

        /// <summary>
        /// Only include accounts created on or before this timestamp UTC.
        /// </summary>
